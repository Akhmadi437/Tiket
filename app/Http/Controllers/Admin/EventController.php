...
class EventController extends Controller
{
    ...
    {
        $events = Event::with('kategori', 'lokasi')->latest()->get();
    ...
    public function show(string $id)
    {
        ...
        // ✅ ambil tiket event + relasi ticketType
        $tickets = $event->tikets()->with('ticketType')->get();

        // ✅ ini untuk dropdown pilih tipe ticket di modal
