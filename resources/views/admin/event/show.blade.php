<x-layouts.admin title="Detail Event">
    ...
    <form method="POST" action="{{ route('admin.tickets.store') }}" class="modal-box">
        ...
        <div class="modal-action">
            ...
            <button class="btn" type="button" onclick="add_ticket_modal.close()">Batal</button>
        </div>
    </form>
</dialog>

<dialog id="edit_ticket_modal" class="modal">
    <form method="POST" class="modal-box" id="editTicketForm">
        @csrf
        @method('PUT')
        ...
        <div class="modal-action">
            ...
            <button class="btn" type="button" onclick="edit_ticket_modal.close()">Batal</button>
        </div>
    </form>
</dialog>

<dialog id="delete_modal" class="modal">
    <form method="POST" class="modal-box" id="deleteTicketForm">
        @csrf
        @method('DELETE')
   ...
   <script>
    ...
    function openEditModal(button) {
        const id = button.dataset.id;
        const ticketTypeId = button.dataset.tickettype;
